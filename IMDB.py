...
from sklearn.naive_bayes import GaussianNB  # Добавлен импорт
from google.colab import drive

# Монтируем Google Drive
drive.mount('/content/drive')

# Читаем файл с правильным путем (ЗАМЕНИТЕ НА СВОЙ ПУТЬ)
...
# Сначала проверим наличие пустых значений
print(f"Пустые значения в колонке 'review': {df['review'].isnull().sum()}")

# Заполним пустые значения пустой строкой
...
# Добавляем GaussianNB который был пропущен
gnb = GaussianNB()
